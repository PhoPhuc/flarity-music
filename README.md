...
[![Release](https://img.shields.io/badge/Release-v1.1.6-FA243C?style=for-the-badge)](https://github.com/PhoPhuc/flarity-music/releases/tag/v1.1.6)
...
[**Download**](https://github.com/PhoPhuc/flarity-music/releases/tag/v1.1.6) · [**Features**](#features) · [**Benchmarks**](#benchmarks) · [**Build from Source**](#build-from-source)
...
Latest release: [**v1.1.6**](https://github.com/PhoPhuc/flarity-music/releases/tag/v1.1.6)

### Windows (x64)
| File | Description |
|---|---|
| [`Flarity-Music-1.1.6-x64-setup.exe`](https://github.com/PhoPhuc/flarity-music/releases/download/v1.1.6/Flarity-Music-1.1.6-x64-setup.exe) | Installer (NSIS) |
| [`Flarity-Music-1.1.6-portable-x64.zip`](https://github.com/PhoPhuc/flarity-music/releases/download/v1.1.6/Flarity-Music-1.1.6-portable-x64.zip) | Portable ZIP — extract and run |
| [`Flarity-Music-1.1.6-x64.msi`](https://github.com/PhoPhuc/flarity-music/releases/download/v1.1.6/Flarity-Music-1.1.6-x64.msi) | MSI installer |
